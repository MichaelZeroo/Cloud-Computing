...
{
    public partial class BankFiction3Context : DbContext
    {
        ...
        public BankFiction3Context(DbContextOptions<BankFiction3Context> options)
        : base(options)
        { }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Transactions>(entity =>
            {
                ...
                entity.Property(e => e.DateOfFulfillment).HasColumnType("datetime");
