...
{
    public partial class CDQ3_S01_MusicContext : DbContext
    {
        public CDQ3_S01_MusicContext()
        {
        }

        public CDQ3_S01_MusicContext(DbContextOptions<CDQ3_S01_MusicContext> options)
            : base(options)
        {
        }
